	...
	<section class="fundraising-campaign-donation section-padding" id="campaign-donation">
		<div class="container"><div class="campaign-donation-card">
			...
			<form class="campaign-inline-donation-form" id="campaign-inline-donation-form" novalidate>
				...
				<label class="campaign-gift-aid"><input type="checkbox" id="campaign-donor-gift-aid"><img class="gift-aid-logo" src="<?php echo esc_url( EMC_ASSETS . '/images/gift-aid.png' ); ?>" alt="<?php esc_attr_e( 'Gift Aid', 'emc-theme' ); ?>"><span><strong><?php esc_html_e( 'Add Gift Aid', 'emc-theme' ); ?></strong><?php esc_html_e( 'I am a UK taxpayer and would like EMC to reclaim Gift Aid on this donation.', 'emc-theme' ); ?></span></label>
